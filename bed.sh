...
table_annovar.pl  ./$1.raw.vcf /opt/seqtools/annovar/humandb -buildver hg19 -out  ./$1.raw.vcf.anno -remove -protocol refGene,1000g2015aug_all,1000g2015aug_eas,dbscsnv11,cosmic70,clinvar_20180326,avsnp150,exac03,esp6500siv2_all,esp6500siv2_ea,dbnsfp33a -operation g,f,f,f,f,f,f,f,f,f,f -nastring . -vcfinput